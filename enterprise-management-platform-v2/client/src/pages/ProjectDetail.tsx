...
import { ArrowLeft, Calendar, CheckCircle2, FileText, ListTodo, MapPin, Plus, Users, Briefcase } from "lucide-react";
import WorkPackagesManager from "@/components/WorkPackagesManager";
      ...
      <div className="container mx-auto py-6">
        <Tabs defaultValue="overview" className="w-full">
          ...
          <TabsContent value="workpackages" className="space-y-6">
            <WorkPackagesManager projectId={projectId} />
          </TabsContent>
        </Tabs>
      </div>
    </div>
